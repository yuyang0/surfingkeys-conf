...
maps["www.google.com"] = [
  ...
  {
    alias: "b",
    description: "Open search in Bing",
    callback: actions.go.bing,
  },
  {
    alias: "sgh",
    description: "Search site:github.com",
    callback: () => actions.go.siteSearch("github.com"),
  },
  {
    alias: "sre",
    description: "Search site:reddit.com",
    callback: () => actions.go.siteSearch("reddit.com"),
  },
  {
    alias: "szh",
...
maps["baidu.com"] = [
  ...
  },
  {
    alias: "d",
    description: "Open search in duckduckgo",
    callback: actions.baidu.ddg,
  },
]

// Bing
const bingResultSelector = [
  "li.b_algo h2 a",
  "li.b_ans a",
  "div.pageRecoContainer .pagereco_TTitle a",
...
maps["bing.com"] = [
  ...
  },
  {
    alias: "g",
    description: "Open search in Google",
    callback: actions.bing.goog,
  },
  {
    alias: "d",
    description: "Open search in Duckduckgo",
    callback: actions.bing.ddg,
  },
]
